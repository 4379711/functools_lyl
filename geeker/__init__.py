...
__UpdateTime__ = '2020/08/11 16:10'
__Version__ = "1.3.6"

__Description__ = """If you don't know how to use it,try to input 
                        <geeker --help> on command line ."""
    ...
    all_module = {
        ...
        "MyLog": """
                功能:
                    ...
                    """,
        'Concurrency': """
                    Concurrency :控制函数执行频率(多线程模型,协程无效)
                    使用方法：
        ...
        'MyDict': '''
                ...
                ''',
        'SponsoredProducts': """
                    Advertising API 亚马逊广告API,目前仅实现SP部分
